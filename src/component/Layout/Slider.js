            ...
            <div className="row">
              <div className="col-sm-12">
                <div id="slider-carousel" className="carousel slide" data-ride="carousel">
                  ...
                  <link to="#slider-carousel" className="left control-carousel hidden-xs" data-slide="prev" />
                  <i className="fa fa-angle-left" />
                  <link to="#slider-carousel" className="right control-carousel hidden-xs" data-slide="next" />
